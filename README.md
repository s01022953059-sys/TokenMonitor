...
curl -L -o "Token Monitor.dmg" \
  "https://gitcode.com/baggiopeng/TokenMonitor/releases/download/v1.4.75/Token%20Monitor.dmg"
...
curl -L -o TokenMonitor-Setup.exe \
  "https://gitcode.com/baggiopeng/TokenMonitor/releases/download/v1.4.75/TokenMonitor-Setup.exe"
```
...
```bash
# 1. bump 版本号 (两处)
#    Info.plist: <string>1.4.75</string>
#    go_build/main.go: var appVersion = "1.4.75"

# 2. git 提交 + 打 tag
git add -A
git commit -m "release: v1.4.75"
git tag v1.4.75
git push origin main
git push origin v1.4.75
...
最新版本：[v1.4.75](https://gitcode.com/baggiopeng/TokenMonitor/releases/v1.4.75)

- macOS: [Token Monitor.dmg](https://gitcode.com/baggiopeng/TokenMonitor/releases/download/v1.4.75/Token%20Monitor.dmg)
- Windows 安装与自动更新: [TokenMonitor-Setup.exe](https://gitcode.com/baggiopeng/TokenMonitor/releases/download/v1.4.75/TokenMonitor-Setup.exe)
