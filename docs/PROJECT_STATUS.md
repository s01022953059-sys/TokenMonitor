...
- Mac: `https://gitcode.com/baggiopeng/TokenMonitor/releases/download/v1.4.30/Token Monitor.dmg`
- Windows: `https://gitcode.com/baggiopeng/TokenMonitor/releases/download/v1.4.30/TokenMonitor-Setup.exe`
